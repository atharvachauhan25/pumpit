...
- **Popular Curves**: Get started instantly with 8 pre-designed volume shapes (Standard Duck, Short Duck, Gate, Pump, etc.).
- **Custom Curve Editor**: Draw your own volume modulation shapes directly in the GUI.
- **Tempo Synced**: Always stays perfectly in time with your DAW's host tempo.
- **Beat Divisions**: Select from standard rhythmic values (1/8, 1/4, 1/2, 1/1).
- **Mix Control**: Dial in the exact amount of ducking using the Dry/Wet mix knob.
- **Lightweight**: Low CPU usage, making it ideal for dropping onto multiple tracks.

## Formats Supported
- VST3 (Windows/macOS)
- AU (macOS)
*Note: Currently prioritizing VST3 for Windows, with more builds coming later.*
